...
function renderNode(){
  ...
  // ...and on the Courses face the Articulations chip names them up here, since
  // the block itself sits below 55 member rows on a course like FIRE 110 X.
  else if(lit) h+=cplNamesHtml(nd, "u-exl");
