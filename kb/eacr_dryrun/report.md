...
|---|---:|---:|---:|
| EACR card count | **3,345** | **2,406** | -939 (+28.1%) |
...
| Status | Cards | Notes |
|---|---:|---|
| Classified (KB-mapped) | 2,264 | raw_title was in `unified_titles.json` |
| Unclassified (raw-fallback) | 142 | preserved 1:1 from today; surfaces re-classification backlog |
| Quality-flagged | 182 | at least one constituent raw row carries `quality_flag = "suspect_course_as_exhibit"` |

### Row coverage

- Rows with classified unified_title + issuer: **10,599** / 11,004
- Rows with unified_title but missing credential entry (issuer unknown): **0**
- Rows with no unified_title (raw-fallback): **405**
...
| **AP Physics C: Mechanics** / College Board / Standardized Assessment / Local | 15 | 181 | 81 | `AP Physics C: Mechanics (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP - Physics C Mechanics` (4) · `AP Exam: Physics C- Mechanics` (3) |
...
| **AP Physics C: Electricity and Magnetism** / College Board / Standardized Assessment / Local | 13 | 175 | 80 | `AP Physics C: Electricity/Magnetism (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP - Physics C Electricity/Magnetism` (4) · `AP Physics C: Electricity and Magnetism` (2) |
...
| **POST Basic Academy** / California Commission on Peace Officer Standards and Training (POST) / Industry Certification / Local | 9 | 89 | 22 | `Peace Officer Standards Training (POST) Basic Academy` (25) · `POST - Peace Officer Standards and Training - Basic Academy Certificate` (23) · `CA POST Academy SMCCD` (22) |
...
| **AP Precalculus** / College Board / Standardized Assessment / Local | 8 | 14 | 10 | `AP Precalculus (Score of 3-5)` (4) · `AP Precalculus` (3) · `AP Exam Precalculus (Score 3-5)` (2) |
...
- Raw titles in current MAP with no `unified_titles.json` entry: **141**
- Rows affected: **405**
...
- old EACR cards: **3,345**
  - unchanged (same merged_id post-pivot): **2,105**
  - folded into a larger card (new merged_id): **1,240**
- new cards receiving 2+ old flag namespaces (potential conflict if both flagged differently): **301**
