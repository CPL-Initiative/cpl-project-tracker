...
|---|---:|---:|---:|
| EACR card count | **3,345** | **2,415** | -930 (+27.8%) |
...
| Status | Cards | Notes |
|---|---:|---|
| Classified (KB-mapped) | 2,219 | raw_title was in `unified_titles.json` |
| Unclassified (raw-fallback) | 196 | preserved 1:1 from today; surfaces re-classification backlog |
| Quality-flagged | 182 | at least one constituent raw row carries `quality_flag = "suspect_course_as_exhibit"` |

### Row coverage

- Rows with classified unified_title + issuer: **10,404** / 11,004
- Rows with unified_title but missing credential entry (issuer unknown): **0**
- Rows with no unified_title (raw-fallback): **600**
...
|---|---:|---:|---:|---|
| **AP World History: Modern** / College Board / Standardized Assessment / Local | 25 | 127 | 82 | `AP World History: Modern (score 3-5): Cal-GETC Area 3B or 4` (79) · `AP Exam World History: Modern (Fall 2025 and after)` (7) · `AP Exam World History: Modern (prior to Fall 2025)` (5) |
| **AP Calculus BC** / College Board / Standardized Assessment / Local | 19 | 128 | 82 | `AP Calculus BC (score 3-5): Cal-GETC Area 2` (78) · `AP Exam Calculus BC (Score 3-5)` (11) · `AP Exam: Calculus BC` (8) |
...
| **AP Calculus AB** / College Board / Standardized Assessment / Local | 16 | 190 | 81 | `AP Calculus AB (score 3-5): Cal-GETC Area 2` (78) · `AP Calculus BC/ AB sub score (score 3-5): Cal-GETC Area 2` (78) · `AP Exam Calculus AB (Score 3-5)` (14) |
...
| **AP Physics C: Mechanics** / College Board / Standardized Assessment / Local | 14 | 179 | 81 | `AP Physics C: Mechanics (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP - Physics C Mechanics` (4) · `AP Exam: Physics C- Mechanics` (3) |
...
| **AP English Language and Composition** / College Board / Standardized Assessment / Local | 13 | 33 | 14 | `AP Exam English Language and Composition (Score 3-5)` (11) · `AP English Language and Composition` (6) · `AP - English Language/Composition` (3) |
...
| **AP European History** / College Board / Standardized Assessment / Local | 12 | 110 | 81 | `AP European History (score 3-5): Cal-GETC Area 3B or 4` (79) · `AP European History` (7) · `AP Exam European History (Score 3-5)` (6) |
| **AP Physics C: Electricity and Magnetism** / College Board / Standardized Assessment / Local | 12 | 173 | 80 | `AP Physics C: Electricity/Magnetism (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP - Physics C Electricity/Magnetism` (4) · `AP Physics C: Electricity and Magnetism` (2) |
| **AP Chemistry** / College Board / Standardized Assessment / Local | 11 | 183 | 81 | `AP Chemistry (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP Chemistry` (7) · `AP Exam: Chemistry` (6) |
| **AP Art History** / College Board / Standardized Assessment / Local | 11 | 113 | 82 | `AP Art History (score 3-5): Cal-GETC Area 3A or 3B` (78) · `AP Art History` (12) · `AP Exam: Art History` (7) |
...
| **AP Psychology** / College Board / Standardized Assessment / Local | 11 | 102 | 81 | `AP Psychology (score 3-5): Cal-GETC Area 4` (79) · `AP Psychology` (8) · `AP Exam: Psychology` (4) |
...
| **AP United States History** / College Board / Standardized Assessment / Local | 10 | 32 | 15 | `AP Exam United States History` (6) · `AP Exam: U. S. History` (6) · `AP U.S. History` (5) |
...
| **AP German Language and Culture** / College Board / Standardized Assessment / Local | 10 | 19 | 10 | `AP German Language` (4) · `AP German -Language & Culture` (3) · `AP - German Language & Culture` (3) |
...
| **AP Environmental Science** / College Board / Standardized Assessment / Local | 9 | 175 | 81 | `AP Environmental Science (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP Environmental Science` (5) · `AP - Environmental Science` (4) |
| **AP Comparative Government and Politics** / College Board / Standardized Assessment / Local | 9 | 19 | 15 | `AP Comparative Government and Politics` (4) · `AP Exam Comparative Government and Politics (Score 3-5)` (4) · `AP Exam: Comparative Government & Politics` (3) |
...
| **AP Statistics** / College Board / Standardized Assessment / Local | 9 | 99 | 81 | `AP Statistics (score 3-5): Cal-GETC Area 2` (78) · `AP Statistics` (6) · `AP Exam Statistics` (5) |
...
| **POST Basic Academy** / California Commission on Peace Officer Standards and Training (POST) / Industry Certification / Local | 8 | 76 | 21 | `Peace Officer Standards Training (POST) Basic Academy` (25) · `POST - Peace Officer Standards and Training - Basic Academy Certificate` (23) · `CA POST Academy SMCCD` (22) |
| **AP Human Geography** / College Board / Standardized Assessment / Local | 8 | 98 | 82 | `AP Human Geography (score 3-5): Cal-GETC Area 4` (78) · `AP Human Geography` (7) · `AP Exam Human Geography (Score 3-5)` (4) |
...
| **AP Computer Science Principles** / College Board / Standardized Assessment / Local | 7 | 13 | 10 | `AP Computer Science - Principles` (3) · `AP Exam Computer Science Principles (Score 3-5)` (3) · `AP: Computer Science Principles` (2) |
| **AP Music Theory** / College Board / Standardized Assessment / Local | 7 | 19 | 17 | `AP Music Theory` (9) · `AP Exam: Music Theory (Score of 4 or 5)` (3) · `AP Exam Music Theory (Score 3-5)` (2) |
| **AP Precalculus** / College Board / Standardized Assessment / Local | 7 | 12 | 9 | `AP Precalculus (Score of 3-5)` (4) · `AP Precalculus` (3) · `AP Precalculus (Score of 3)` (1) |
...
| **Paramedic License** / California Emergency Medical Services Authority (EMSA) / Industry Certification / Local | 7 | 60 | 8 | `California Paramedic License` (12) · `Paramedic Certificate` (12) · `Paramedic Licensure` (12) |
| **AP Physics 1** / College Board / Standardized Assessment / Local | 7 | 169 | 81 | `AP Physics 1: Algebra-Based (score 3-5): Cal-GETC Area 5A and 5C` (156) · `AP Exam: Physics 1` (6) · `AP Physics 1: Algebra-Based` (2) |
...
| **IB Theatre HL** / International Baccalaureate (IB) / Standardized Assessment / Local | 6 | 88 | 81 | `IB Theatre HL (score 5-7): Cal-GETC Area 3A` (79) · `IB Exam Theatre HL` (3) · `IB Theatre HL` (3) |
| **Defense Language Proficiency Test (DLPT) — Spanish** / Defense Language Institute Foreign Language Center (DLIFLC) / Standardized Assessment / Statewide | 6 | 30 | 5 | `Spanish Defense Language Proficiency Test (DLPT) Score 1` (8) · `Spanish Defense Language Proficiency Test (DLPT) Score 1+` (8) · `Spanish Defense Language Proficiency Test (DLPT) Score 2` (8) |
| **CLEP Information Systems and Computer Applications** / College Board / Standardized Assessment / Local | 6 | 10 | 9 | `CLEP Exam: Information Systems and Computer Applications` (3) · `CLEP Exam Information Systems and Computer Apps (Score of 50 or higher)` (3) · `CLEP Information Systems and Computer Applications (SAC Associate Degree Units)` (1) |

## Re-classification backlog

- Raw titles in current MAP with no `unified_titles.json` entry: **194**
- Rows affected: **600**
...
- old EACR cards: **3,345**
  - unchanged (same merged_id post-pivot): **2,115**
  - folded into a larger card (new merged_id): **1,230**
- new cards receiving 2+ old flag namespaces (potential conflict if both flagged differently): **300**
