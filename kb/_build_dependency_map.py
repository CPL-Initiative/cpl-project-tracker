...
SEEDS = [
    ...
    {   # prototype/skyview.html: DESC_DIR="ccr_desc"; fetch(DESC_DIR+"/"+…+".json")
        "file": "prototype/skyview.html",
        "anchor": r'DESC_DIR\s*\+\s*"/"',
        "datasets": [("file:prototype/ccr_desc/*.json", "read")],
        "why": "per-discipline shards; generated by kb/_build_ccr_universe.py, NOT committed",
    },
