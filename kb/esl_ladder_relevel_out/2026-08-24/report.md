...
Rule: max rung observed over the whole ESL corpus, >= 2 distinct rungs, length 3-9; a 2-rung read abstains because Sam's table has no L=2 row.

Colleges with a readable ladder: **71**. ⚠️ A further **21** read as 2-rung ladders, which Sam's table does not cover — they abstain, and whether to extend the table to L=2 is his call.
...
- re-levels proposed: **130**
- of which REVERT one of the 32 already applied: **30**
- unchanged: 1118 · undecided: 561 · purpose carve-outs skipped: 181
- against the colleges' own catalogs: agrees 31, disagrees 39, silent 60

### Moves

| From → to | n |
|---|---:|
| Beginning -> Intermediate | 64 |
...
| Other proposals | 100 | 71 | 31 | 17 | 52 |
...
**Recommendation: do NOT roll back the applied 32 on this evidence.** The other 100 proposals run 31 agree to 17 disagree and are the better candidates — but work the multi-member ones first.
