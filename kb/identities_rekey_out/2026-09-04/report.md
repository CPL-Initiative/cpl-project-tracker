# Identities map re-key — dry run 2026-09-04

status: DRY-RUN 2026-09-04 — nothing applied

- entries: **2,346** · ghosts: **1,597** · after: **2,118**
- re-key: **1,369** (titles agree on 1,217) · drop, collision: **44** · drop, converged: **9** · drop, dead: **175**
...
2. Drop 175 entries no map names again (proposed: yes — nothing can display them).
