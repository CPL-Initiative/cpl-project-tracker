...
(function () {
  ...
  function init() {
    ...
    var fProv = sel("uc-prov", "Generated by: any", ["by subject-code", "by title-keyword", "by description", "by TOP code", "by TOP division"]);
    ...
    function passes(r) {
      ...
      if (state.prov) {
        var wantSrc = state.prov === "by subject-code" ? "subject_map"
          ...
          : state.prov === "by description" ? "description"
          : state.prov === "by TOP code" ? "top_code" : "top_division";
