...
(function () {
  ...
  function init() {
    ...
    var fProv = sel("uc-prov", "Generated by: any", ["by subject-code", "by title-keyword"]);
    ...
    function passes(r) {
      ...
      if (state.prov) {
        var wantSrc = state.prov === "by subject-code" ? "subject_map" : "title_keyword";
      ...
      if (statusOf(r) === "Verified") {
        ...
        if (r.dsrc) {
          var provLabel = r.dsrc === "subject_map" ? "⚙ subj-code"
            : r.dsrc === "title_keyword" ? "⚙ title-kw" : "⚙ " + r.dsrc;
          var provCls = r.dsrc === "title_keyword" ? "warn" : "ok";
