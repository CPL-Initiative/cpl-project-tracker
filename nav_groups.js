...
(function () {
  ...
  var GROUPS = [
    ...
    { id: 'reference', label: 'Reference & Curation', tabs: ['unified-courses', 'canonical-subj4', 'coci-lookup', 'cip-crosswalk', 'credential-reference', 'exhibit-adoption', 'tmc-builder', 'pipeline', 'our-process'] },
