...
| Smoke 15a's fourth negation shape (a negated reading verb, then a quotation) | fixed: the reading verbs joined the stripper's can't-say shape, fixture + controls in `smoke_negation_stripper.test.js` (37) |
