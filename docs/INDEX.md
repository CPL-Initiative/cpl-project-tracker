...
created: 2026-05-27
updated: 2026-06-17 (Session 60 — Bruh Momentus: TMC Builder list-first directory #454 + quickstart-bar pin #455 + the GE Breadth companion / full ADT #456 + Cal-GETC verified vs Standards v1.3 #457; reference-tmc-adt-data-model bumped with the GE half + session_61_handoff. Session 59 = Bruh Star Navicus, the TMC Builder tab #450–#452)
...
| [Reference — TMC / ADT data model & the C-ID auto-match (the transfer chain, the two in-repo sources, the exact-match rule; + the GE Breadth half of the full ADT)](kb-notes/reference-tmc-adt-data-model.md) | reference | published | 2026-06-16 | 2026-06-17 (Session 60 — GE Breadth patterns: Cal-GETC/IGETC/CSU-GE, verify-against-own-authority) |
...
| [`tmc_builder_lessons.md`](tmc_builder_lessons.md) | TMC Builder tab — interactive ADT submission: fixed C-ID left / per-college COCI-dropdown right, C-ID auto-match, Total Units, Supabase Save/Resume + export. Session 59 (Star Navicus): all 45 TMCs from official PDFs + curator layer (#450–#452). **Session 60 (Momentus): list-first directory #454 + quickstart pinned #455 + GE Breadth companion / full ADT #456 + Cal-GETC verified vs Standards v1.3 #457.** Data model in [`kb-notes/reference-tmc-adt-data-model.md`](kb-notes/reference-tmc-adt-data-model.md) | **Session 60 (2026-06-17)** |
...
| 59 → 60 | Design lane (Bruh Star Navicus): the TMC Builder tab — all 45 official TMCs from the PDFs + curator layer (login, CO-review queue, notes, PDF artifacts) #450–#452 → embed CPL natively on the TMCs, faculty-verify the drafts | [`session_60_handoff.md`](session_60_handoff.md) |
| 60 → 61 | Design lane (Bruh Momentus): TMC Builder list-first directory #454 + quickstart pinned #455 + the GE Breadth companion / full ADT #456 + Cal-GETC verified vs Standards v1.3 #457 → verify IGETC/CSU-GE, the CPL-native TMC-slot wiring | [`session_61_handoff.md`](session_61_handoff.md) |
