...
created: 2026-05-27
updated: 2026-06-28 (Session 81 — StarFarout: ① RACI/Activity nudge tweaks (PR #574); ② the Fact Sheet Curate arc — add/delete/reorder boxes #576, "My CPL Stories" headless-sourced section #577, add/resize/delete images via a Supabase Storage bucket #578; NEW kb-notes methodology-affordance-visibility-vs-action-eligibility + methodology-reserved-key-namespaces-on-overrides-table)
