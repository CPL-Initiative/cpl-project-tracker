...
| KB notes | 447 | [`catalog/kb-notes.md`](catalog/kb-notes.md) |
...
## Update history
- **2026-09-16 (S263, later)** — the external credential registry lands: 369 California occupational and professional licenses (complete) and 974 of 6,738 national industry certifications, captured by Sam against a blocked domain. New KB note on authority files vs. votes; a second matcher defect measured and left unfixed.
