...
created: 2026-05-27
updated: 2026-06-02 (Session 28 close-out — EACR PR-4 prescriptive layer + v2-card fixes, post-freeze)
...
| [Playbook — EACR consolidation + master-detail gallery scope (Local+CCC merge, versioned gallery, 3 audience views, 4-phase ladder, backlog)](kb-notes/eacr-consolidation-scope.md) | playbook | published | 2026-06-01 | 2026-06-02 (Session 28: **PR-4 shipped — ladder DONE**) |
...
| [Methodology — A native `<details>` with a hidden marker needs a restored affordance + guarded toggle](kb-notes/methodology-styling-native-details-toggle.md) | methodology | published | 2026-06-02 | 2026-06-02 |
...
| [`eacr_consolidation_lessons.md`](eacr_consolidation_lessons.md) | EACR consolidation + Local+CCC merge + master-detail gallery (v2) + **PR-4 prescriptive layer + v2-card fixes** | **Session 28 (2026-06-02, post-freeze close-out)** |
...
| 28 → 29 | Bruh 28 / "Recovery" (handoff) | [`session_29_handoff.md`](session_29_handoff.md) |
