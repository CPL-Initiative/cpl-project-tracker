...
created: 2026-05-27
updated: 2026-06-28 (Session 81 — StarFarout: RACI/Activity nudge tweaks — per-row 📣 on every matrix row + a 📣 Nudge button on every Activity/sub-activity/project card + bulk button renamed "Nudge All" (PR #574); NEW kb-note methodology-affordance-visibility-vs-action-eligibility)
