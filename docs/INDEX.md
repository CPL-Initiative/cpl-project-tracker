...
created: 2026-05-27
updated: 2026-06-28 (Session 82 — SkyFlyer: Fact Sheet editable-everywhere + WCAG 2.1 AA + Word export (PR #584) — Vet-Sprint editable / KPI move-only / budget hide-only / per-grid Add box, ~15 embedded links, a11y pass, print fixes, new ⬇ Word export; NEW kb-notes methodology-stable-dom-keys-exclude-live-text + playbook-standalone-dom-to-word-export)
