...
## 2026-08-20 — Sky174: drag-to-reorder the priorities, "funding factor", and the Year-2 mirror
...
⚠️ **This doc is now ~2,670 lines.** `kb/_docs_audit.py` will flag it as
`oversized_doc`; the next checkpoint on this workstream should compact the
2026-06/07 sections rather than append to them.
