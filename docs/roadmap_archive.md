...
## INDEX update-history entries rotated out (2026-09-22)
...
## INDEX update-history entries rotated out (2026-09-18)
...
## INDEX update-history entries rotated out (2026-09-10)
...
### SkyLedger S213 — the sheet caught up with its lane, and the probe groundwork banked (2026-08-30)
...
- **2026-09-02 (SkyLead, S221 — lead with the table; the explainer is the public view)** — **One PR (#1436).** Sam's seven asks: the institution table is the FIRST section after the introduction on the tab and the explainer (*"most won't care about the details, just their funding"*); every section is closed on open except those two — per VISIT now, the per-browser fold store retired; the Summary sits inside the introduction's box (R11 re-aimed to its requirement: never hidden on open); the priority cards are a fixed two-column pair; the card's "Combined funding" line is gone (it restated the band head, the Target line and the price line). ⭐ The explainer hosts the tab's OWN college section in a new embed mode instead of painting a second table from the payload — the hidden engine mount was an embed waiting to happen — and paints the timing milestones and each priority's strategies from the engine. Story: `cpl_funding_lessons`; handoff `session_222_handoff`.
...
## Moved from CLAUDE.md §11 at the S227 checkpoint (2026-09-04)
...
## Docs INDEX update history, trimmed 2026-09-05 (Session 231)
...
## INDEX update history, archived 2026-09-06 (S234)
...
## CLAUDE.md session narrative, archived 2026-09-06 (S234)
...
## docs/INDEX.md update history, trimmed 2026-09-07 (S237)
...
### INDEX update history, moved 2026-09-07 (S239)
...
## `docs/INDEX.md` update history — entries moved 2026-09-07 (Session 239)

*(Trimmed from INDEX's `## Update history` per `/checkpoint` step 6, which caps it at ~8. Moved verbatim; the four indented lines were already orphaned from an earlier trim.)*
...
## INDEX update history, moved 2026-09-08 (S243) to keep the list at ~8
...
## Moved from docs/INDEX.md update history (2026-09-09)
...
## INDEX update history, archived 2026-09-09
...
## Moved from docs/INDEX.md update history (2026-09-09, S248)
...
## Trimmed from docs/INDEX.md update history (2026-09-09, SkySight)
...
## Archived from docs/INDEX.md update history (2026-09-10)
...
## Rotated out of docs/INDEX.md update history (2026-09-10)
*Retired from `docs/INDEX.md`'s Update history at the S251 checkpoint (2026-09-10), verbatim:*
...
## Rotated out of docs/INDEX.md update history (2026-09-10, S249)
...
## INDEX update history, trimmed 2026-09-11
...
## INDEX update-history overflow

Bullets trimmed from `docs/INDEX.md` § Update history when the list passed ~8, verbatim, newest first.
...
## INDEX update-history entries retired 2026-09-11 (S257)

> Moved verbatim from `docs/INDEX.md`'s Update history when that list passed the
> ~8-bullet guideline. Nothing edited.
...
## INDEX update-history entries archived 2026-09-17 (S272)

Moved verbatim from `docs/INDEX.md` when its list passed ~8 bullets.
...
## INDEX update-history entries archived 2026-09-17 (S273)
...
<!-- INDEX update-history bullet rotated 2026-09-18 (S274) -->
...
## INDEX update history (archived from docs/INDEX.md)

Older bullets from the `## Update history` section of `docs/INDEX.md`, moved verbatim when the list passed eight (the checkpoint command's step 6).
...
## Moved from docs/INDEX.md update history (2026-09-19, S278)
...
## INDEX update-history entries archived 2026-09-20 (S280)
...
### INDEX update-history bullets trimmed 2026-09-24 (S285)
...
### INDEX update-history bullets trimmed 2026-09-25 (S288)
...
## INDEX update-history entries archived 2026-09-26 (S294)
