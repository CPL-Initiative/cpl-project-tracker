...
| 2026-09-07 | [`2026-09-07-skyview-globe-prototype.html`](2026-09-07-skyview-globe-prototype.html) | SkyView's committed layout wrapped onto a rotating three.js sphere — Sam's *"3-d 360 globe that rotates"* ask, built to look at rather than argue about: an Outside and an Inside view, the Articulations light, and a line counting the points that face the reader. The data is a build-time snapshot; nothing in the map's own code changed. The one visual with a second external host (three.js from cdnjs), because 49,896 points on a sphere need WebGL. | 🔨 **Three rounds in one day.** Second, on Sam's reaction (*"I like the globe view! Love the glow on the articulations"*): islands eased apart and sized to fit, M-ID color chips, a slower turn, an all-sky inside view. Third, on his next (*"Better! Tweak:"*): the sky **By kind** — CTE disciplines on one side, academic on the other, the mixed ones between (TOP's one sanctioned use, the manual's CTE flag, as a share per discipline); Inside as a window onto the night sky, 30° to 240° across, round islands staying round; star-sized dots in both views; Silver M-IDs; Day (CO blue, ghosted clouds) and Night; Wrapped gone at his word. His close: *"Looks great!!!"*, then a turn that slows with zoom and a gentler twinkle, both built. Generators: `prototype/globe/`. ✅ **Ruled 2026-09-07** — *"Looks great! Let's go with it in next session"*: the sky form goes into SkyView. **Ported the same evening (S239, #1514)** — SkyView opens as the Sky; this page is history. Artifact: https://claude.ai/code/artifact/51f5249d-1884-406d-889e-259b262b86e5 |
| 2026-09-07 | [`2026-09-07-eight-calls-before-the-sky-goes-in.html`](2026-09-07-eight-calls-before-the-sky-goes-in.html) | The design calls the globe's port into SkyView raises, after Sam ruled the sky form in (*"Looks great! Let's go with it in next session"*): which view opens, whether the flat map stays, the Day sky against the dark-canvas rule, motion by default, curation gestures on a curve, By kind as the arrangement, the fate of each prototype control, and the color of the M-ID on the dark ground (silver on the globe, violet on the map, and 99% of the points wear it). Every figure measured on the prototype and the served map (the hemisphere counts, the day-sky contrast, the neighborhood survival under By kind, a Canvas 2D redraw benchmark). Numbered for reply, chips on. | ✅ **Ruled 2026-09-07 — all eight `yes`, no notes, in one sitting (19:59–20:02 UTC)**, and all eight built the same evening (S239, #1514): SkyView opens as the Sky. Artifact: https://claude.ai/code/artifact/5d683e8a-baa7-4ecc-a0b8-140ad3aee18d |
| 2026-09-11 | [`2026-09-11-two-calls-on-sierra.html`](2026-09-11-two-calls-on-sierra.html) | Two settings on Sierra's request that the Sonnet 5 switch made matter: whether the model reasons privately before it answers, and how long an answer may run. Each with the measured stretches of her answer table, an options row a reader can compare, and a proposal. Reply chips name the options. | ✅ **Both ruled 2026-09-11** — reasoning stays off ("giving fantastic answers"); the answer stop goes to 8,192 ("so folks playing around with it always get a complete answer"). Artifact: https://claude.ai/code/artifact/79ef62e3-5034-425f-a657-0973f0a92171 |
