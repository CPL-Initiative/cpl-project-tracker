...
| 2026-09-11 | [`2026-09-11-two-calls-on-sierra.html`](2026-09-11-two-calls-on-sierra.html) | Two settings on Sierra's request that the Sonnet 5 switch made matter: whether the model reasons privately before it answers, and how long an answer may run. Each with the measured stretches of her answer table, an options row a reader can compare, and a proposal. Reply chips name the options. | 🔨 Awaiting Sam's replies — nothing changed on the live assistant |
