---
title: "CPL Assistant (Sierra) lessons — archive"
created: 2026-09-11
updated: 2026-09-11
tags: [lessons, archive, cpl-assistant, sierra, chatbox, rag]
kb-status: internal
...
# CPL Assistant (Sierra) lessons — archive

> Sections moved **verbatim** out of [`docs/cpl_assistant_lessons.md`](cpl_assistant_lessons.md)
> on 2026-09-11 (Session 257, SkyBeat), when `oversized_doc` flagged that doc at
> 122,980 B against its 120,000 B budget — and flagged it on the checkpoint that
> was about to append to it. Nothing here was edited or summarized; the live doc
> keeps the four most recent sections and this holds everything before them.
>
> **Fourteen sections, 2026-06-01 through 2026-08-07.** The live doc is the one
> to append to and the one to read first; come here for the history of a
> decision it now states as settled.
