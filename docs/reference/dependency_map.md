...
| `kb/discipline_aliases.json` | tabs: `canonical-subj4` · scripts: `kb/_alias_canon.py`, `kb/_apply_drama_theater_convergence.py`, `kb/_apply_kin_pe_convergence.py`, `kb/_zband_retire_dryrun.py` | — |
...
Coverage: 74 Supabase tables · 30 RPCs · 5 edge functions · 405 file
datasets · 137 external services · 308 consumers · 33 workflows · 37 tabs.
