...
|---|---|---|
| `  - kb/csr_authority_codes_rulings_<date>.json` | scripts: `kb/_authority_recode_dryrun.py` | — |
...
| `csr_authority_codes_rulings_<date>.json` | scripts: `kb/_authority_recode_dryrun.py` | — |
...
| `kb/authority_recode_out/2026-09-03/seed_edits.json` | scripts: `kb/_authority_recode_dryrun.py` | — |
...
| `kb/foreign_language_subj4.json` | tabs: `canonical-subj4` · scripts: `kb/_authority_recode_dryrun.py`, `kb/_fl_subj4_dryrun.py`, `kb/_subj4_dryrun.py` | — |
...
Coverage: 74 Supabase tables · 30 RPCs · 5 edge functions · 403 file
