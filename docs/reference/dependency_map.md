...
| `tmc_college_courses.js` | `CPL_TMC_COLLEGE_COURSES` | `tmc/_build_college_courses.py` | tabs: `tmc-builder` · scripts: `kb/_build_occupation_cpl_crosswalk.py`, `kb/_build_regional_cpl_opportunity.py`, `tmc/_build_college_adts.py`, `tmc/_build_college_courses.py` |
...
| `kb/_build_ccr_cpl_universe_members.py` | workflows: `daily-dashboard.yml` | — |
...
| `kb/_build_remint_blast_radius.py` | workflows: `js-tests.yml` | — |
...
| `kb/college_short_names.json` | scripts: `chatbox/build_coci_offerings.py`, `funding/_build_funding_ess.py`, `funding/_build_funding_performance.py`, `kb/_build_college_identity_crosswalk.py`, `kb/_build_domain_cpl_crosswalk.py`, `kb/_build_regional_cpl_opportunity.py`, `kb/_seed_college_short_names.py`, `tmc/_build_college_adts.py` | scripts: `kb/_seed_college_short_names.py` |
...
| `kb/esl_fold_spotcheck/<date>/worklist.json` | scripts: `kb/_esl_relevel_dryrun.py`, `kb/_esl_sheet_apply_build.py` | — |
...
| `prototype/ccr_cpl_universe.json` | scripts: `kb/_build_ccr_cpl_universe.py` | committed by: `daily-dashboard.yml` |
| `prototype/ccr_cpl_universe_members.json` | scripts: `kb/_build_ccr_cpl_universe_members.py` | committed by: `daily-dashboard.yml` |
...
| `tests/jev_battery_test.py` | workflows: `js-tests.yml` | — |
...
| `claude.ai` | tabs: `admin` · scripts: `kb/_build_esl_merging_decision_sheet.py`, `kb/_build_open_asks_decision_sheet.py`, `kb/_esl_new_identities_dryrun.py`, `kb/_esl_sheet_apply_build.py`, `scripts/announce_session_hint.py` · workflows: `cpl-chat-health.yml`, `map-users-sync.yml` |
...
Coverage: 85 Supabase tables · 31 RPCs · 5 edge functions · 528 file
datasets · 147 external services · 371 consumers · 35 workflows · 37 tabs.
