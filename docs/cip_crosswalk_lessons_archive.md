---
title: "CIP Crosswalk tab + the CIP site — archived lessons (2026-07-14 → 2026-07-17)"
date: 2026-07-14
updated: 2026-08-14
tags: [lessons, archive, cobi, org-layer, cip, top-cip, crosswalk, coci]
related:
  - "[[cip_crosswalk_lessons]]"
  - "[[noncredit_cip_category_scope]]"
---

# CIP Crosswalk — archived lessons

Sections from the build-out of the CIP tab and the TOP→CIP "easy button",
**2026-07-14 through 2026-07-17**, moved here verbatim on 2026-08-14 because the
live lessons doc had crossed the `oversized_doc` limit (155 KB against a 120 KB
budget) and the next checkpoint was about to append to it. Everything here is
SHIPPED and settled; the live doc carries 2026-07-28 onward.

Live doc: [`cip_crosswalk_lessons.md`](cip_crosswalk_lessons.md).
