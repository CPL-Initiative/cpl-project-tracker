---
title: "SkyView / CCR Atlas lessons — archive"
created: 2026-09-05
updated: 2026-09-05
tags: [lessons, archive, ccr, skyview]
kb-status: internal
obsidian-folder: cpl-project-tracker/lessons
related:
  - "[[CLAUDE]]"
---
...
> when it passed its 120 KB budget (Session 231, 2026-09-05). Nothing here was
> edited on the way across; the live doc keeps the recent sessions and this
> holds the rest. Read it when you need the history of a decision the live doc
> refers to but no longer narrates.
