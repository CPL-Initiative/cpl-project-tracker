  ...
  function render() {
    ...
    var COLS = [
      ...
      { key: "students",        label: "Students",
        title: "Students with CPL credit recommendations for this credential, statewide (MAP Exhibit CRs Catalog, TotalStudentsForCR) — a volume signal for prioritizing curation, not a distinct headcount. Sort to surface the highest-impact credentials. Counts below 5 are masked as \"<5\" for privacy; \"—\" = no catalog match yet. Populates on the daily MAP pull." },
