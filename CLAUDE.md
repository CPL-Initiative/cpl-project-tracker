...
| **Implementation Funding tab / the $35M model** | The priorities, their shares and factors, what counts toward each, and the college-by-college allocation. | ✅ live · **3 on the [funding review sheet](https://claude.ai/artifact/9MfbN6jqio8as9mY4LwPB2)** — [lane state](docs/reference/lanes/implementation-funding.md) |
