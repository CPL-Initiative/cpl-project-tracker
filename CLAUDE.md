...
**Both merged, NEITHER LIVE** until `cpl-chat` is deployed.
Story `docs/cobi_memory_tab_lessons.md` · handoff `docs/session_191_handoff.md`.

### Sky190 — a stale copy said a busy college was empty (2026-08-25)
