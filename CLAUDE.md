...
### SkyNaut — the spec was wrong in four places, and 30 real rows found all of them (2026-08-08, #1049–#1054 MERGED)
...
suppression, complementary suppression). Story: `docs/student_detail_load_lessons.md` · handoff `docs/session_129_handoff.md`.
