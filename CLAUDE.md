...
| **Title 5 §55050 → Ed. Code Article 9** | A regulation that does not implement the statute it operates under — and the amendment package that fixes it. | ✅ **DELIVERED; SAM RULED ON ALL FIVE OPEN CALLS AND REVISED TWICE — v3 IS THE MERGE** (Sky196, #1339 · #1341–#1352). ⭐ **THE ASK WAS A FRESH REDRAFT AND THE ANSWER IS A RESTORE** — a final §55050 already exists, adopted by the BOG **2026-08-12**, and **its renumbering is Sam's own November 2025 work**. ⭐ **NOBODY ERRED**: stamp 6/19/26, Article 9 effective 7/13/26. ⭐ **THE ARGUMENT IS ABOUT DISTRICTS** — §78093.2(b)(1)/(b)(2) bind every campus TODAY. ⭐ **SB 135 IS WIDER THAN ARTICLE 9: §75013 is Sec. 14 of the SAME chapter**, its (b) opens *"As part of the Credit for Prior Learning Initiative"* (CO + ASCCC **shall** make CPL recommendations **per program**, **the same systemwide**, by **2027-07-01**), and it moves the program-level/GE-area broadening **from Tier 2 to Tier 1**. **A section-number range is not a scope** — every scoping doc read §§78093–78093.2 and stopped. ✅ **§88782 CONFIRMED as the Career Passport Program**; it **NAMES MAP IN STATUTE** and makes CPL a **named input to the Passport** — the argument for keeping the (l) annotation. ✅ **HIS FIVE RULINGS:** (m) demographics restored · (b) keeps the documents list · competencies restored · **Cal-GETC deliberately NOT restored** (the generic *"local or transfer general education area"* is his anti-staleness lever, and it sidesteps §66025.71 still naming IGETC/CSU-GE Breadth) · independent institutions kept. ⚠️ **NOTHING RE-LETTERS** — adopted §55051(d) points at §55050(i), a pointer the SAME rulemaking created; new material appends as (n)/(o). ⚠️ **THE ADOPTED PDF IS A REDLINE AND `pdftotext` DROPS THE FORMATTING** — draft against the generated `t5_55050_clean_after_2026-08-12.txt`; **reject-all must reproduce the adopted text** (`kb/_verify_55050_redline.py`, **86 checks**, 4 perturbations, one per ruling). ⚠️ **His "cleaned up version" was built on the FIRST draft, not v2** — parallel descendants, so v3 MERGES them; **check which ancestor a returned file has before merging**. ⭐ **REGISTER COMPARISON DONE** — **6 of 16 CPL rows drafted**, and the draft closes **2 of the 4 gaps** the SB 135 sweep called uncovered. ✅ **ROW #9 SETTLED 2026-08-26 — STRUCK.** Sam asked whether the Ed. Code requires the transcript annotation; **it does not** (§78093.2(b)(2) binds the RECEIVING campus, §88782(a)(1) binds the CO, and §88782(b) builds the Passport off MAP). The earlier keep-it argument was about **enforceability, not law** — withdrawn. Identification lives in the draft's own **(b)(4)** infrastructure duty instead. ⚠️ **#10 wants a second look** (it was #9's counterweight; recording the CREDIT ≠ flagging its SOURCE). ✅ **(f) *"course content"* CONFIRMED DELIBERATE** (Sam, 2026-08-26) — a tracked change against the adopted *"outcomes"*, disclosed in drafting note (2): **(h) already says "course content"**, so (f) and (h) now describe one standard in one set of words. ⭐ **Final lettering (a)–(n), contiguous**, asserted by the verifier. ⭐ **§75013(a) hands row #7 a venue it never had** — a CBE→FTES workgroup reporting to the **Department of Finance** by 2028-10-01, row #7's own named obstacle. ⚠️ **Row #16's instrument says `§55050(d)`** — the adoption moved that clause to **(c)**. **NEEDS SAM:** ① **row #9**, before anything is filed; ② the four v3 changes he has not ruled on ((l) restore + grading→(o), §75013(b) in (c), §75013 in the NOTE, CPL expanded in (b)(4)); ③ row #2 still asks for enacted law; ④ ✅ Sponsor **James Todd, VC Academic Affairs** · Staff Lead **Mari Estrada**; ⑤ the 2026–27 timeline; ⑥ Tier 2 timing — the grading clause needs its **§55023** companion, and the fee amendment gains a second anchor in **§88782(c)(3)** *"no or low cost"*. Register comparison: [`docs/t5_55050_vs_gr_register.md`](docs/t5_55050_vs_gr_register.md) · review [`docs/t5_55050_sam_revision_review.md`](docs/t5_55050_sam_revision_review.md) · story [`docs/t5_55050_lessons.md`](docs/t5_55050_lessons.md); durable [`a-change-inherits-every-reference-into-it`](docs/kb-notes/methodology-a-change-inherits-every-reference-into-it.md) · [`resolve-a-redline-as-an-edit-list`](docs/kb-notes/methodology-resolve-a-redline-as-an-edit-list.md). |
