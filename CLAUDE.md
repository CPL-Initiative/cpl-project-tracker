...
| **Title 5 §55050 → Ed. Code Article 9** | A regulation that does not implement the statute it operates under — and the amendment package that fixes it. | ✅ **PACKAGE DRAFTED AND DELIVERED; SAM HAS REVISED IT (59 tracked changes) AND THE REVIEW IS BACK TO HIM** (Sky196, #1339 · #1341–#1350). ⭐ **THE ASK WAS A FRESH REDRAFT AND THE ANSWER IS A RESTORE** — a final §55050 already exists, adopted by the BOG **2026-08-12**, and **its renumbering is Sam's own November 2025 work**. ⭐ **NOBODY ERRED**: stamp 6/19/26, Article 9 effective 7/13/26 — a conformity amendment, not a criticism. ⭐ **THE ARGUMENT IS ABOUT DISTRICTS**: §78093.2(b)(1)/(b)(2) bind every campus TODAY, so a district following the adopted §55050 to the letter is out of compliance with the Ed. Code. ⚠️ **NOTHING RE-LETTERS** — adopted §55051(d) points at §55050(i), a pointer the SAME rulemaking created and therefore invisible to a search of the operative text; new material appends. ⚠️ **THE ADOPTED PDF IS A REDLINE AND `pdftotext` DROPS THE FORMATTING** — draft against the generated `t5_55050_clean_after_2026-08-12.txt`, never the extraction; **reject-all must reproduce the adopted text** (`kb/_verify_55050_redline.py`, 71 checks, 4 perturbations). ⭐ **SB 135 IS WIDER THAN ARTICLE 9 — §75013 is Sec. 14 of the SAME chapter**, and its (b) opens *"As part of the Credit for Prior Learning Initiative"*: CO + ASCCC **shall** make CPL recommendations **per program**, **the same systemwide**, by **2027-07-01**, colleges **strongly encouraged to award consistent with them**. **Anything scoped to §§78093–78093.2 alone misses it.** This moves the program-level/GE-area broadening **from Tier 2 to Tier 1** and repairs the weaker of the two named stretches. ✅ **§88782 CONFIRMED as the Career Passport Program** — the adopted NOTE is right, November's §88792(b)(1) was a transposition; **§88782(b) NAMES MAP IN STATUTE** (⚠️ as *"…Pathways **Initiative**"*, colliding with the house convention — quote statutory names verbatim), and **§88782(a)(1) makes CPL a named input to the Passport**, which is the argument for KEEPING the adopted (l) annotation Sam deleted. ⚠️ **FIVE FIXES BEFORE FILING, one of them not optional**: restore **gender/race-ethnicity** in (m) (its deletion contradicts §75013(c)(2)(B) *in the same bill* and the equity condition on the money); restore the adopted **procedures** list in (b) (replaced by the §78093.2(b)(1) **documents** list — a category error that also duplicates (e) verbatim); restore **"evaluation of authenticated competencies"** (the only competency word in the section, struck just as §78093.2(a)(5)/§75013/§88782(a)(2) make competency the direction — the BOG already moved (f) from *content* to *outcomes*); keep the **Cal-GETC** sentence (deleting text adopted three weeks ago is what recharacterizes conformity as reopening the rulemaking); move the **independent-institutions** clause off the district duty (§78093.2(c)(2) puts it on the SYSTEM, permissively). ⚠️ **ONE FILE DEFECT: "only" deleted from (c) with NO tracked change** — reject-all no longer reproduces the adopted text and no reviewer can see a restriction was removed. **NEEDS SAM:** ① (m) demographics (recommend keep both); ② Cal-GETC; ③ how hard (b)(4) mandates the platform; ④ does (c) move to Tier 1 (recommend yes); ⑤ Tier 2 timing — the new grading (l) needs its **§55023** companion; ⑥ Sponsor / Staff Lead; ⑦ the 2026–27 timeline. Review: [`docs/t5_55050_sam_revision_review.md`](docs/t5_55050_sam_revision_review.md) · story [`docs/t5_55050_lessons.md`](docs/t5_55050_lessons.md); durable [`a-change-inherits-every-reference-into-it`](docs/kb-notes/methodology-a-change-inherits-every-reference-into-it.md) · [`resolve-a-redline-as-an-edit-list`](docs/kb-notes/methodology-resolve-a-redline-as-an-edit-list.md). |
...
**Sam: *"My priority today is to get a new draft Title 5 55050 to the CO."*** (#1339, #1341–#1347).
⭐ **He asked for a fresh redraft; the answer is a RESTORE.** A final §55050 already exists, adopted
by the Board of Governors on 2026-08-12 — and **its renumbering is Sam's own November 2025 work**.
Same section, substance missing.
⭐ **Nobody erred**: the accessibility stamp reads 6/19/26, Article 9 took effect 7/13/26. That one
fact turns a criticism into an ordinary conformity amendment.
⭐ **The point that lands is about districts** — two Ed. Code duties bind every campus today, so a
district following the adopted §55050 to the letter is still out of compliance.
⭐ **File Tier 1 alone**: the tiers carry different burdens of proof, and bundling makes the
near-certain win inherit the contested one's.
⚠️ **A cross-reference the SAME rulemaking created locked the lettering** — adopted §55051(d) points
at §55050(i), invisible to a search of the operative text. Everything new appends as (n).
⚠️ **The adopted PDF is a redline and `pdftotext` drops the formatting** — 21 run-together collisions,
7 unmarked struck paragraphs, and one phrase that resolves two ways in one section. Resolved as an
edit list, not retyped; the subdivisions coming out (a)–(m) contiguous is what proved it.
⭐ **Reject-all must reproduce the adopted text** — 71 checks, 4 perturbations, and it caught a
deleted `" and"` that had orphaned its comma.
...
model**. Story `docs/t5_55050_lessons.md` · `docs/cobi_memory_tab_lessons.md` · handoff
`docs/session_197_handoff.md`.
