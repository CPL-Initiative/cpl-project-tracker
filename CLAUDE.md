...
Storage bucket; [`docs/kb-notes/tmc-adt-document-upload-scope.md`](docs/kb-notes/tmc-adt-document-upload-scope.md)).
...
**unverified-M-ID renumber re-mint scope** ([#494](docs/unverified_mid_renumber_scope.md) —
full Rule-7, unverified-only, close-gaps+re-sort, one pass *after the merge wave settles*)
and the live-merge durability note
([`reference-ccr-curation-sync-and-live-merge.md`](docs/kb-notes/reference-ccr-curation-sync-and-live-merge.md)).
Full stories: [`docs/ccr_cluster_cleanup_lessons.md`](docs/ccr_cluster_cleanup_lessons.md) +
