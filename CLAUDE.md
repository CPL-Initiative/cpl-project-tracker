...
| **ESL packaging (the first fold)** | Collapse the ESL discipline to comprehensives + carve-outs — the proof that packaging reaches the target. | ✅ live · open work · **9 on the [ESL merging sheet](https://claude.ai/artifact/LaZmu7NYj11DigAEbxsUMS)** — [lane state](docs/reference/lanes/esl-packaging.md) |
