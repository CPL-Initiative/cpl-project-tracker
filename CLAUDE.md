...
> **Session narratives 26-31 archived** →
> [`docs/roadmap_archive.md`](docs/roadmap_archive.md#archived-session-narratives-sessions-2631).
> The Session-25 strategic queue (above) and the most-recent session (32,
> below) stay inline.
