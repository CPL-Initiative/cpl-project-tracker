...
(function () {
  ...
  function buildLifecycleDiagram(counts) {
    ...
    return [
      ...
      "  classDef seed fill:#FEF3C7,stroke:#92400E,color:#1C1C1A",
      "  classDef verified fill:#DBEAFE,stroke:#1E40AF,color:#1C1C1A",
      "  classDef mcready fill:#E0E7FF,stroke:#3730A3,color:#1C1C1A",
      "  classDef submitted fill:#FCE7F3,stroke:#9D174D,color:#1C1C1A",
      "  classDef approved fill:#DCFCE7,stroke:#166534,color:#1C1C1A",
      "  classDef backlog fill:#FEE2E2,stroke:#991B1B,color:#1C1C1A",
      "  class S0 seed",
      "  class S1 verified",
      "  class S2 mcready",
      "  class S3 submitted",
  ...
  function buildPhase1eDiagram() {
    return [
      ...
      "  I --> J",
      "  J --> K",
      "  classDef receipt fill:#DCFCE7,stroke:#166534,stroke-width:2px,color:#1C1C1A",
      "  classDef commit fill:#FEF3C7,stroke:#92400E,color:#1C1C1A",
      "  class K receipt",
      "  class J commit",
    ].join("\n");
  }
