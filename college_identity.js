...
(function () {
  ...
  function ensureCss() {
    ...
    var css = [
      ...
      ".cid-sub { font-size:.86rem; color:var(--text-muted, #5a6478); max-width:74ch; margin:0 0 14px; }",
      ...
      ".cid-note { font-size:.82rem; color:var(--text-muted, #5a6478); margin:8px 0; max-width:78ch; }",
