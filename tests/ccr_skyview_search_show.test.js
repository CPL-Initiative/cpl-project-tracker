...
(async () => {
   ...
   * place preserved. */
  {
    ...
    // ⭐ THE COUNT MOVED TO THE HEADER with the order control (Sam, 2026-09-06:
    // "I did ask for this sort by name to be moved in the upper right corner").
    // The footer is now the way OUT and holds the Enter button alone, so the
    // count is asserted where a reader now reads it.
